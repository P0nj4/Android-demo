package com.example.germanpereyra.instaslam.activities;
...
import com.example.germanpereyra.instaslam.R;
import com.example.germanpereyra.instaslam.model.InstaImage;
...
public class MediaActivity extends AppCompatActivity {
        ...
        AsyncTask.execute(new Runnable() {
            ...
            public void run() {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        //TODO: set images on recycleview
                    }
                });
            }
        });
    ...
    public class imagesViewHolder extends RecyclerView.ViewHolder {
        ...
        public void updateUI(InstaImage image){
            DecodeBitmap task = new DecodeBitmap(this.imageThumb,image);
            task.execute();
//            this.imageThumb.setImageBitmap(decodeURI(image.getImgResourceURL().getPath()));
        }
    ...
    public class ImagesAdapter extends RecyclerView.Adapter<imagesViewHolder> {
        ...
        public void onBindViewHolder(imagesViewHolder holder, int position) {
            final InstaImage img = images.get(position);
            final imagesViewHolder imageholde = holder;
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    selectedImage.setImageDrawable(imageholde.imageThumb.getDrawable());
                }
            });
        }
    }
