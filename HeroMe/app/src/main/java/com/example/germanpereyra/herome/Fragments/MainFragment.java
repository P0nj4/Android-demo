package com.example.germanpereyra.herome.Fragments;
...
import com.example.germanpereyra.herome.Activities.MainActivity;
import com.example.germanpereyra.herome.R;
...
public class MainFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        bornButton = (Button)view.findViewById(R.id.bprnButton);
    ...
    public void onClick(View view) {
        ...
        accidentButton.setCompoundDrawablesRelativeWithIntrinsicBounds(R.drawable.lightning,0,0,0);
        bornButton.setCompoundDrawablesRelativeWithIntrinsicBounds(R.drawable.rocket,0,0,0);
        mutationButton.setCompoundDrawablesRelativeWithIntrinsicBounds(R.drawable.atomic,0,0,0);

        switch (btn.getId()) {
            case R.id.accidentButton:
                leftDrawable = R.drawable.lightning;
                break;
            case R.id.bprnButton:
                leftDrawable = R.drawable.rocket;
                break;
            case R.id.mutationButton:
